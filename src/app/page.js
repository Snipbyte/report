    ...
    <main className="overflow-hidden">
      ...
      <AnimatedSection>
        <section className="mt-40 lg:mt-60 px-4">
          <p className="text-4xl lg:text-7xl my-4 font-bold text-headingColor text-center">
            Offer Overview
          </p>
      ...
      <AnimatedSection>
        <p className="text-4xl lg:text-7xl mb-10 mt-6 font-bold text-headingColor text-center">
          Our Services
        </p>
        <div className="flex flex-wrap items-center p-2 lg:p-0 justify-center gap-12">
          <ServiceCard
            image="financingsimulators.jpg"
            heading="Financing Simulators"
          />
          <ServiceCard
            image="businessplangenerator.jpg"
      ...
      <AnimatedSection>
        <section className="my-12 lg:my-24 px-4 text-center">
          ...
          <p className="text-lg text-paraColor mb-4">
            Discover Expert Solutions and Custom Strategies for Your Investment
            Success.
          </p>
          <div className="flex flex-wrap w-full justify-center gap-4 lg:gap-6">
            <ImageCard
              ...
              des="Receive detailed analyses and specific recommendations tailored to your project with just a few clicks."
            />
            <ImageCard
          ...
          <div>
            <p className="text-headingColor text-lg text-center my-4">
              Start your personalized simulation today and pave the way to
              success!
            </p>
