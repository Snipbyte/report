    ...
    return (
        <div>
            ...
            <div className='lg:flex block p-4 my-6 gap-5'>
                ...
                <div className='lg:w-1/2 w-full'>
                    <InvestmentCard />
                    <button className='text-headingColor text-sm w-full text-end my-2'>
                        Learn more about the use of my personal data
                    </button>
                </div>
            </div>
            <div className='my-6'>
                <p className='lg:text-2xl text-xl text-center bg-desColor p-2 font-bold text-btnColor'>
                    ...
                    <table className="min-w-full bg-white border border-gray-200">
                        ...
                        <tbody>
                            <tr className="even:bg-gray-100">
                                ...
                                {[...Array(11)].map((_, index) => (
                                    <td key={index} className="px-4 py-2 text-sm text-headingColor border border-gray-200">
                ...
                <div className='flex items-center'>
                    <p className='lg:text-2xl text-xl w-full bg-desColor p-2 font-bold text-btnColor'>
