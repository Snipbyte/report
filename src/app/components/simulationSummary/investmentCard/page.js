...
const InvestmentCard = () => {
    return (
        <div className='bg-lightCard border-2 p-4 w-full h-full' >
            <p className='text-btnColor font-bold text-2xl mt-16 mb-8'>Which investment to choose?</p>
            <div className='flex items-center justify-between border-b border-blue-500 pb-5'>
                <div className='text-headingColor text-sm font-bold'>
            ...
            <div className='flex justify-end'>
                <button className='w-72 p-2 bg-btnColor text-white hover:bg-hoverBtnColor text-center rounded-md mt-4'>Request for full study</button>
            </div>
            <p className='text-headingColor text-sm w-full text-end mt-2'>Confidential and without obligation</p>
        </div>
    )
}
