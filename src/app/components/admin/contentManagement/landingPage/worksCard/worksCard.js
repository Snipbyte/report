...
const WorksCard = () => {
    ...
    const placeholders = language === 'English'
        ? ['Heading', 'Description 1', 'Description 2', 'Description 3', 'Description 4', 'Button']
        : ['Titre', 'Description en français 1', 'Description en français 2', 'Description en français 3', 'Description en français 4', 'Bouton'];
    ...
    return (
        <div className='flex flex-col items-center gap-4 p-4 border-2 my-2'>
            ...
            <div className='flex gap-2 items-center w-full'>
                ...
                <div className='w-[50%]'>
                    <Image
                        src="/images/landingpage5.jpg" // Fixed image that does not change
