    ...
    return (
        <div className='flex flex-col items-center border-2 p-4 my-4'>
            ...
            <div className='flex gap-2 items-center w-full'>
                <div className='flex flex-col w-full lg:w-[50%]'>
                    {placeholders.map((placeholder, index) => (
                        <input
                            ...
                            type='text'
                            placeholder={placeholder} // Apply the correct placeholder based on language
                        />
                    ))}
                    ...
                    <div className='relative my-2'>
                        <input
                            ...
                            type='file'
                            accept="image/*"
                            onChange={handleFileChange} // Handle file change (preview the image)
                        />
                        {file && (
                            <div className='relative mt-2'>
                                <Image
                                    src={file} // Show the preview image
                                    alt="Preview"
                                    width={100}
                                    height={100}
                ...
                {/* Display the Default Image (Always displayed) */}
                <div className='w-[50%]'>
                    <Image
                        src="/images/cm9.jpg" // Default image stays as is
