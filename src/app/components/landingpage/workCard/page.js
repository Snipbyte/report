      ...
      <div className="w-full  lg:w-[50%]  bg-lightCard  p-10">
        <div className="flex items-center gap-6 bg-blue-200 p-3 rounded-md my-4">
          ...
          <p className="text-headingColor  text-md my-4">
            Choose Your Simulator and Expert: Select the tool and guidance that
            suits your needs.{" "}
          </p>
        </div>
        <div className="flex items-center gap-6 bg-blue-200 p-3 rounded-md my-4">
          ...
          <p className="text-headingColor  text-md my-4">
            Enter Your Data: Provide the necessary information for indepth
            analysis.
          </p>
        </div>
        <div className="flex items-center gap-6 bg-blue-200 p-3 rounded-md my-4">
          ...
          <p className="text-headingColor  text-md my-4">
            Instantly Receive Your Personalized Report: Obtain an eligibility
            score and recommendations to optimize your success chances.{" "}
          </p>
        </div>
        <div className="flex items-center gap-6 bg-blue-200 p-3 rounded-md my-4">
          <IoPersonSharp className="w-12 h-12 border border-white p-2" />
          <p className="text-headingColor  text-md my-4">
            Benefit from an Expert Consultation: Our specialists guide you to
