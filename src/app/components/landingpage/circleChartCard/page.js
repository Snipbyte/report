...
const CircleChartCard = () => {
    return (
        ...
        <div className='lg:w-1/2 w-full p-4 lg:p-7'>
            ...
            <div className='flex items-center gap-5 my-4'>
                ...
                <div>
                    ...
                    <p className='text-paraColor text-sm my-1'>Assess your funding eligibility with precise scoring based on bank and investment fund criteria.</p>
                </div>
            </div>
            <div className='flex items-center gap-5 my-4'>
