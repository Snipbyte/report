        ...
        <div className="relative bg-lightCard ">
            <div className="lg:flex items-center block my-10">
                <div className="w-full lg:w-[40%]">
                    <p className="lg:text-5xl text-2xl md:text-4xl font-bold text-headingColor my-6 w-60 mx-auto">Why Choose IziKemp?</p>
                </div>
                <div className="w-full  lg:w-[60%]  bg-lightCard  p-10">
                    <div className="bg-blue-100 border-2 border-white p-1 rounded-md my-4">
                        <p className="text-headingColor  text-md my-4">

                            {t("chooseSimulator")}
                        </p>
                    </div>
                    <div className="bg-sky-100 border-2 border-white p-1 rounded-md my-4">
                        <p className="text-headingColor  text-md my-4">
                            {t("enterData")}
                        </p>
                    </div>
                    <div className="bg-green-100 border-2 border-white p-1 rounded-md my-4">
                        <p className="text-headingColor  text-md my-4">
                            {t("receiveReport")}
                        </p>
                    </div>
                    <div className="bg-teal-100 border-2 border-white p-1 rounded-md my-4">
                        <p className="text-headingColor  text-md my-4">
