    ...
    return (
        <div className='w-full lg:w-[45%] bg-paraColor p-4 rounded-md'>
            ...
            <div className='flex flex-wrap my-6 items-center gap-3'>
                <button className='text-lightCard text-lg underline hover:text-btnColor duration-700'>{props.service1}</button>
                <button className='text-lightCard text-lg underline hover:text-btnColor duration-700'>{props.service2}</button>
                <button className='text-lightCard text-lg underline hover:text-btnColor duration-700'>{props.service3}</button>
