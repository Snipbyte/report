  ...
  resources: {
    en: {
      translation: {
        ...
        demoMsg:"Explore the app with a guided tour and discuss how it would fit into your processes!",
        bookDemo:"Book Demo",
        ...
        helpInfo:" For any inquiries or specific issues, feel free to contact us via our form or on social media. Join our dynamic community of successful entrepreneurs!",
        smallBsn1:"Petite entreprise",
        smallBsn:"Small Business Calculators",
        bsnDesc: "Own a small business? Chances are you face difficult decisions about how to allocate scare resources every day. Use Bankrate's small business calculators to fine tune your strategy.",
      },
    },
    fr: {
      translation: {
        ...
        demoMsg:"Explorez l'application avec une visite guidée et discutez de la manière dont elle s'intégrerait dans vos processus!",
        ...
        helpInfo:"Pour toute demande ou problème spécifique, n'hésitez pas à nous contacter via notre formulaire ou sur les réseaux sociaux. Rejoignez notre communauté dynamique d'entrepreneurs à succès!",
        smallBsn1:"Small Business",
        smallBsn:"Calculatrices pour petites entreprises",
        bsnDesc: "Vous avez une petite entreprise ? Il y a de fortes chances que vous soyez confronté à des décisions difficiles sur la manière d'allouer des ressources limitées chaque jour. Utilisez les calculatrices pour petites entreprises de Bankrate pour affiner votre stratégie.",
      },
    },
  },
